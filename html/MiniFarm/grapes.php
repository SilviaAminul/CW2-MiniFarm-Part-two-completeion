...
<section id="grapes">
    <div class="grape_heading">
        <h3>Grapes</h3>

    </div>

    <div class=Grapes_description>
        <h2>Description</h2>
        <h3>Lorem ipsum dolor sam, quis nostrum exeris suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur.
            borum.
        </h3>
    </div>
    <div class="Grapes_container">
        <div class="Grapes_box">
