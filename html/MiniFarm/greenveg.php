...
<section id="fruits">
    ...
    <div class="fruit_container">
        <div class="fruit_box">
            <img src="/images/greenveg1.jpg" alt="grapes">
        ...
        <div class="fruit_box">
            <img src="/images/greenveg2.jpg" alt="Apple">
        ...
        <div class="fruit_box">
            <img src="/images/greenveg3.jpg" alt="bananas">
        ...
        <div class="fruit_box">
            <img src="/images/greenveg4.jpg" alt="grapes">
            <strong>Fine Beans</strong>
            <span class="quantity">1 kg</span>
            <span class="price">£1.00</span>
            <a href="#" class=cart_button><i class="fa fa-shopping-cart "></i>Add to Cart</a>
        </div>
        ...
        <div class="fruit_box">
            <img src="/images/greenveg5.jpg" alt="grapes">
            <strong>Leeks</strong>
            <span class="quantity">1 kg</span>
            <span class="price">£1.00</span>
            <a href="#" class=cart_button><i class="fa fa-shopping-cart "></i>Add to Cart</a>
        ...
        <div class="fruit_box">
            <img src="/images/greenveg6.jpg" alt="grapes">
