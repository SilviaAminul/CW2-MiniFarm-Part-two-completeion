...
<section id="fruits">
    ...
    <div class="fruit_container">
        <div class="fruit_box">
            <img src="/images/salad1.jpg" alt="grapes">
        ...
        <div class="fruit_box">
            <img src="/images/salad2.jpg" alt="Apple">
        ...
        <div class="fruit_box">
            <img src="/images/salad3.jpg" alt="bananas">
        ...
        <div class="fruit_box">
            <img src="/images/salad4.jpg" alt="grapes">
            <strong>Red Pepper</strong>
            <span class="quantity">1 kg</span>
            <span class="price">£1.00</span>
            <a href="#" class=cart_button><i class="fa fa-shopping-cart "></i>Add to Cart</a>
        </div>
        ...
        <div class="fruit_box">
            <img src="/images/salad5.jpg" alt="grapes">
            <strong>Spring Onion</strong>
            <span class="quantity">1 kg</span>
            <span class="price">£1.00</span>
            <a href="#" class=cart_button><i class="fa fa-shopping-cart "></i>Add to Cart</a>
        </div>
        ...
        <div class="fruit_box">
            <img src="/images/salad6.jpg" alt="grapes">
            <strong>Avacados</strong>
            <span class="quantity">1 kg</span>
            <span class="price">£1.00</span>
            <a href="#" class=cart_button><i class="fa fa-shopping-cart "></i>Add to Cart</a>
        </div>
