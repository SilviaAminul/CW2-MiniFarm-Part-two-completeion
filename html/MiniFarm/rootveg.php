...
<section id="fruits">
    ...
    <div class="fruit_container">
        <div class="fruit_box">
            <img src="/images/rootveg1.jpg" alt="grapes">
        ...
        <div class="fruit_box">
            <img src="/images/rootveg2.jpg" alt="Apple">
            <strong>Parnisps</strong>
            <span class="quantity">1 kg</span>
            <span class="price">£1.00</span>
            <a href="#" class=cart_button><i class="fa fa-shopping-cart "></i>Add to Cart</a>
        </div>
        ...
        <div class="fruit_box">
            <img src="/images/rootveg3.jpg" alt="bananas">
        ...
        <div class="fruit_box">
            <img src="/images/rootveg4.jpg" alt="grapes">
        ...
        <div class="fruit_box">
            <img src="/images/rootveg5.jpg" alt="grapes">
            <strong>Rainbow Carrots</strong>
            <span class="quantity">1 kg</span>
            <span class="price">£1.00</span>
            <a href="#" class=cart_button><i class="fa fa-shopping-cart "></i>Add to Cart</a>
        </div>
        ...
        <div class="fruit_box">
            <img src="/images/rootveg6.jpg" alt="grapes">
